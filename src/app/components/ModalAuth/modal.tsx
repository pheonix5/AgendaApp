...
const authSchema = yup.object().shape({
  ...
  senha: yup
    .string()
    .min(6, "A Senha deve ter no Mínimo 6 caracaters")
    ...
    <View className="flex-1 justify-end">
      ...
      <View className="relative w-full h-[75%] rounded-t-[32px] overflow-hidden">
        ...
        <KeyboardAwareScrollView
          className={`absolute h-full ${ABSOLUTFILL} py-10 px-6`}
        >
          <View className="flex-col items-start mb-10">
            ...
            {tipoAcao === "cadastro" ? (
              <Text className="text-white text-3xl leading-[3rem] font-medium">
                Criar Conta
              </Text>
            ) : (
              <Text className="text-white text-3xl leading-[3rem] font-medium">
          ...
          <View className="flex-1 gap-3">
            ...
            <Controller
              ...
              render={({ field: { onChange } }) => (
                <Input.Root
                  erroMessage={errors.senha?.message}
                  tipoAcao={tipoAcao}
                >
            ...
            >
              {loading ? (
                ...
                <>
                  <Button.Text
                    title={tipoAcao === "cadastro" ? "CRIAR CONTA" : "ENTRAR"}
                    className="text-Cgray-300"
                  />
                  <Button.Icon
                    icon={
                      <FontAwesome6
            ...
            {tipoAcao === "cadastro" ? (
              <>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => setTipoAcao("login")}
                >
                  <Text className="text-white text-xl font-titulo">
                    Fazer Login
                  </Text>
                </TouchableOpacity>
              </>
